import KormPhoto from './../assets/productcard.jpg'
    ...
    return (
        <div className='bg-white rounded-sm flex flex-col items-center p-2 group'>
            ...
            <div className='w-full text-left'>
                ...
                <button className='w-full mt-4 bg-[#33c9db] text-white py-2 rounded-md text-[13px] font-medium'>Смотреть</button>
            </div>
        </div>
